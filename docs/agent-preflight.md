...
- Базовые команды сборки и запуска нужно оформлять вокруг Kotlin/JVM workflow.
- После инициализации проекта зафиксировать здесь краткую трактовку команд запуска сервера и клиента.
