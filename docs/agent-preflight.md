...
- Пока проект только инициализируется, конкретные команды сборки и запуска нужно уточнять по фактическому стеку.
- После выбора стека зафиксировать здесь краткую трактовку команд запуска сервера и клиента.
